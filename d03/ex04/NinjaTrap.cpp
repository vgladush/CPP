...
/*   Updated: 2018/07/30 01:40:21 by vgladush         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		NinjaTrap::choise_att(std::string target) {
	...
	else
	{
		...
		if (this->typeCl == 3)
			...
			std::cout << "SP3R-TP ";
		std::cout << this->Name << " use \"" << att[i] << "\" attack and his energy decreased by 21 points. There are only " << this->Energy_points << " energy left!" << std::endl;
		if (i < 4) {
